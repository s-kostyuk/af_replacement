...
class KerasNetAaf(torch.nn.Module):
    """
    KerasNet - CNN implementation evaluated in arXiv 1801.09403 **but** with
    optional support of adaptive activation functions (AHAF, F-Neuron
    ...
    def __init__(
        ...
        super(KerasNetAaf, self).__init__()
        ...
        if flavor == 'MNIST' or flavor == 'F-MNIST':
            ...
            raise NotImplementedError("Other flavors of KerasNet are not supported")
        ...
        self.act1 = af_build(
            af_conv, in_dims=(self.conv1.out_channels, *self._act1_img_dims)
        )
        ...
        self.act2 = af_build(
            af_conv, in_dims=(self.conv2.out_channels, *self._act2_img_dims)
        )
        ...
        self.act4 = af_build(
            af_conv, in_dims=(self.conv4.out_channels, *self._act4_img_dims)
        )
        ...
        self.act5 = af_build(
            af_conv, in_dims=(self.conv5.out_channels, *self._act5_img_dims),
        )
        ...
        self.act7 = af_build(af_fc, in_dims=(self._fc8_out_features,))
